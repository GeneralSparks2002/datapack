...
execute unless score timer_grace variable matches ..0 run give @p[tag=orange,limit=1] item_frame[custom_name='{"color":"#FFA500","italic":true,"text":"Orange Base"}',custom_model_data={strings:[orange]},entity_data={id:"item_frame",Item:{id:"item_frame",count:1,components:{"custom_model_data":{string:[orange]}}},Fixed:1b,Invisible:1b,Silent:1b,Invulnerable:1b,Tags:["OrangeBase"]}] 1
