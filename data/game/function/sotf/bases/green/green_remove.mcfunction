...
execute unless score timer_grace variable matches ..0 run give @p[tag=green,limit=1] item_frame[custom_name='{"color":"#228b22","italic": true,"text": "Green Base"}',custom_model_data={strings:[green]},entity_data={id:"item_frame",Item:{id:"item_frame",count:1,components:{"custom_model_data":{strings:[green]}}},Fixed:1b,Invisible:1b,Silent:1b,Invulnerable:1b,Tags:["GreenBase"]}] 1
