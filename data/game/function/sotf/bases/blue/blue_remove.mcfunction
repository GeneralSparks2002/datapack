...
execute unless score timer_grace variable matches ..0 run give @p[tag=blue,limit=1] item_frame[custom_name='{"color":"dark_blue","italic": true,"text": "Blue Base"}',custom_model_data={strings:[blue]},entity_data={id:"item_frame",Item:{id:"item_frame",count:1,components:{"custom_model_data":{strings:[blue]}}},Fixed:1b,Invisible:1b,Silent:1b,Invulnerable:1b,Tags:["BlueBase"]}] 1
