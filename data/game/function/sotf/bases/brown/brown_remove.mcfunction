...
execute unless score timer_grace variable matches ..0 run give @p[tag=brown,limit=1] item_frame[custom_name='{"color":"#964B00","italic": true,"text": "Brown Base"}',custom_model_data={strings:[brown]},entity_data={id:"item_frame",Item:{id:"item_frame",count:1,components:{"custom_model_data":{strings:[brown]}}},Fixed:1b,Invisible:1b,Silent:1b,Invulnerable:1b,Tags:["BrownBase"]}] 1
